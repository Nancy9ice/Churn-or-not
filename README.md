...
The dataset of this project was analyzed exclusively with Microsoft Excel. However, the summary report was designed with Figma. 
...
* [Delay can make Mavens lose 547 more customers](#DelaycanmakeMavenslose547morecustomers)
...
On July 9, exactly 8:29am, the Chief Marketing Officer (CMO) of Maven Telecoms Company and I had this conversation. 
...
Maven Telecoms Company is experiencing high churn rate and wants to know what attributes that are highly associated with the customers that stop subscribing for their service. 

##  <a name='Methodology'></a>Methodology

The dataset contained 7043 rows and 38 columns. It was void of duplicate values. However, it contained null values. These null values were due to the non-association of the values to the kind of service (Phone or Internet service) that the customers subscribed to.
...
To read a detailed description of the steps I took in my analysis, please click HERE. 
...
The customer records of the Maven Telecoms company from second quarter(Q2) of the year reveals that the company has crossed that milestone of getting 100 customers because currently they have 7043 customers. Or **had** rather. That number reduced to 5174 by the end of this second quarter. This equates to a 26.5% loss in customers. 
...
A quick survey from these customers revealed that 841 of them (about 45% of the total churned customers) are leaving because they found competitors that are offering better. 

![](Charts/Churn%20Rate%20by%20Reason.png)

These customers re leaving for the major reasons of better devices, better offers, higher download, and more data. This is a revelation that most of the customers are using more of the Internet service than the Phone service and the marketers should pay attention to this. 

But come to think of it. If most of the customers are leaving because of competitors, it's most likely that these customers came into the Maven Telecoms Company to test the waters but weren't convinced. 

This was confirmed due to the length of time period that they spent in Mavens. 

##  <a name='Theyaresearchingforthebest'></a>They are searching for the best

The minds of these customers are not yet stable to be transformed to loyal customers. 36% of them are spending 4months or less in Mavens.  

![](Charts/Churned%20Customer%20Count%20by%20Tenure(in%20Months).png)

They are searching for the best and to them, Mavens is not the best. But why should we even bother? Is this affecting their spendings and behavior towards Mavens? The answer is Yes. 
...
You might probably have two questions in your mind. First, maybe this 46% isn't large after all because 43% of these customers are still with us. The difference isn't far so maybe you disagree. Or maybe something is making them to leave. We know it's the competitors but what have we done to them that they had to leave? 

Second, how do we know that these people are spending less? They might actually be going for expensive monthly subscriptions. 

Now, let me answer your first question. 

##  <a name='OfferEiswhatwedidtothem'></a>Offer E is what we did to them
53% of all customers that subscribed for the offer E are leaving. That's more than the stayed and new Offer E subscribers put together. 

![](Charts/Customer%20Percentage%20by%20Offer.png)

But what might be wrong with Offer E? Going back to the reasons these customers left. They left because of better devices, higher download bandwidth, more data, and better offer. Obvioulsy Offer E is not a better offer. It's possible that it lacks these reasons they left or even though these benefits are in the offer, the value might be low. 
...
This number is too great to be looked away. This might be a confirmation that these customers are looking to pay less for more. 

Here's a summary customer profile of customers that are most likely to leave the Mavens Telecmoms Company. 
...
We have already seen that most customers left spent less than $500, stayed for only 4months or less, subscribed to the monthly contract, and/or Offer E. 

The major step to take is to increase the value of Offer E or upsell other offers. Whichever one that is chosen should contain important values like high download bandwidth, and more data. This is solely for the business team to decide. 
...
##  <a name='DelaycanmakeMavenslose547morecustomers'></a>Delay can make Mavens lose 547 more customers
...
The more customers that leave, the more money the business loses. The marketers should pick the records of the customers that have at least one of these four churn risks and start work immediately with the recommended solutions to their critical problem unless they don't love their jobs. 

Click HERE to see details of the steps I took in solving this problem. 
